...
pacstrap /mnt base base-devel linux linux-headers nano btrfs-progs plasma egl-wayland sddm nftables iptables-nft realtime-privileges dbus-broker amd-ucode linux-firmware nvidia nvidia-utils opencl-nvidia nvidia-settings networkmanager konsole dolphin kate
